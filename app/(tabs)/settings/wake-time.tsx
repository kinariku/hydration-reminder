...
export default function WakeTimeSettingsScreen() {
  ...
  useEffect(() => {
    ...
    const hasWakeTimeChanges = wakeTime !== userProfile.wakeTime;
    setHasChanges(hasWakeTimeChanges);
  }, [wakeTime, userProfile]);
  ...
  const handleSave = async () => {
    ...
    if (!timeRegex.test(wakeTime)) return;
    ...
    try {
      ...
      setHasChanges(false);
      console.log('Wake time saved successfully');
    } catch (error) {
